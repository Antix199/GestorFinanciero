...
public class Finanzas {
    ...
    public static double[] getGastosPorCategoria() {
        return gastosPorCategoria.clone();
    }
    public static ArrayList<String>[] getProductosPorCategoria() {
        // Devolvemos un clon del array para evitar modificaciones externas
        return productosPorCategoria.clone();
    }
